...
import sys
sys.path.append('.')
from boosttrack.external.fast_reid.fastreid.config import cfg
from boosttrack.external.fast_reid.fastreid.modeling.backbones import build_resnet_backbone
from boosttrack.external.fast_reid.fastreid.modeling.backbones.resnet_ibn_a import se_resnet101_ibn_a
