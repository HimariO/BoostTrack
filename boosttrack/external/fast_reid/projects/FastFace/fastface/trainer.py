...
from boosttrack.external.fast_reid.fastreid.data.build import _root, build_reid_test_loader, build_reid_train_loader
from boosttrack.external.fast_reid.fastreid.data.datasets import DATASET_REGISTRY
from boosttrack.external.fast_reid.fastreid.data.transforms import build_transforms
from boosttrack.external.fast_reid.fastreid.engine import hooks
from boosttrack.external.fast_reid.fastreid.engine.defaults import DefaultTrainer, TrainerBase
from boosttrack.external.fast_reid.fastreid.engine.train_loop import SimpleTrainer, AMPTrainer
from boosttrack.external.fast_reid.fastreid.solver import build_optimizer
...
from boosttrack.external.fast_reid.fastreid.utils.params import ContiguousParams
