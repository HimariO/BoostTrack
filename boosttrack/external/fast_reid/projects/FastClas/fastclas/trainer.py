...
from boosttrack.external.fast_reid.fastreid.data.build import _root
from boosttrack.external.fast_reid.fastreid.data.build import build_reid_train_loader, build_reid_test_loader
...
from boosttrack.external.fast_reid.fastreid.evaluation.clas_evaluator import ClasEvaluator
from boosttrack.external.fast_reid.fastreid.utils import comm
from boosttrack.external.fast_reid.fastreid.utils.checkpoint import PathManager
